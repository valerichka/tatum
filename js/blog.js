...
function loadMore () {
    var a = document.getElementsByClassName('hidden-posts');
    for (i = 0; i < a.length; i++) {
        a[i].style.display = 'block';
    }
    
    document.querySelector('.load-more.more').style.display = 'none';
    document.querySelector('.load-more.less').style.display = 'inline-block';
}
...
function loadLess() {
    ...
    document.querySelector('.load-more.less').style.display = 'none';
    document.querySelector('.load-more.more').style.display = 'inline-block';
}
